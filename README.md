...
1. `foo_r128_normalizer_v1.7.0.fb2k-component`をダウンロードします。
...
- 処理負荷をリアルタイム監視し、過剰状態が続くと自動安全補正
- 現在の処理状態を「正常／監視中／自動調整中／調整上限」で表示
- 安全な状態が3秒続くと補正をゆっくり解除し、「正常」へ戻る
