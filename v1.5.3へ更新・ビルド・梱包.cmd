...
echo R128 Normalizer v1.5.3
echo Direct settings menu release
echo.

powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\build_v153.ps1"
...
echo 「v1.5.3インストール用ファイルだけ作成.cmd」を実行し直せます。
